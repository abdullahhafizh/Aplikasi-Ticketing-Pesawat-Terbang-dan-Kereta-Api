                ...
                <div class="panel-body">                    
                    ...
                    <div class="row">
                        <div class="col-md-6">                            
                            ...
                            <form id="edit-form" action="{{ url('route') }}/{{ $route->id }}/edit" method="POST" style="display: none;">
                                {{ csrf_field() }}
                            </form>
                        </div>
                        <div class="col-md-6">                            
                    ...
                    <form id="delete-form" action="{{ url('route') }}/{{ $route->id }}/destroy" method="POST" style="display: none;">
                        {{ csrf_field() }}
                    </form>
                </div>                        
            </div>
